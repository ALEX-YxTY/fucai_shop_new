...
public class ActForgotPwd extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		mEtVcode = findViewById(R.id.et_v_code);
		mEtPwd = findViewById(R.id.et_passwd);
		mEtReinputPwd= findViewById(R.id.et_reinput_passwd);
		mTvSendCode = findViewById(R.id.tv_verify);
	...
	private void reset(){
		...
		if(StringUtils.isNullOrEmpty(pwdRe)||!pwd.equals(pwdRe))
		{
