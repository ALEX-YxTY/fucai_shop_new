...
public class ConstUtil {
    ...
    public static final String getUploadCacheDirPath() {
        ...
        // + MyApplication.instance.getPackageName() + "/cache/upload";
        String state = Environment.getExternalStorageState();
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            return Environment.getExternalStorageDirectory() + File.separator + "mspt" + File.separator + "upload";
        } else {
            return MyApplication.instance.getCacheDir().getAbsolutePath() + File.separator + "upload";
        }
    }
    ...
    // } else {
    // return MyApplication.instance.getCacheDir().getAbsolutePath() + File.separator + "disclose";
    // }
    // }
    ...
    public static String getWebServerUrl() {
        // return MyApplication.instance.getString(R.string.web_server_url);
        return Cookies.getWebSvr();
    }


    public static String getFileServerUrl(String relativeUrl) {
        if (StringUtils.isNullOrEmpty(relativeUrl)) {
            return "";
        }
